...
@mcp.tool()
async def chronos_forecast_service(history_values:list[int|float], pred_length:int) -> str:
    """
...
@mcp.tool()
async def moirai_forecast_service(history_values:list[int|float], pred_length:int) -> str:
    """
